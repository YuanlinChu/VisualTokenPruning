    ...
    def __init__(self, controller_addr, worker_addr,
        ...
        if tpruning_infer:
            if layer_list is not None:
                ...
                logger.info(f"Set layer_list: {layer_list_parsed}")
            
            if image_token_ratio_list is not None:
                ratio_list = eval(image_token_ratio_list) if isinstance(image_token_ratio_list, str) else image_token_ratio_list
                self.model.model.image_token_ratio_list = ratio_list
